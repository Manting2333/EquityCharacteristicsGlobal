...
secd = pd.read_pickle('./secd_chn_2000.pkl')
...
secd = secd[ (secd['exchg'] == 249) | (secd['exchg'] == 250)] # shanghai / shenzhen
secd = secd[secd['curcdd']=='CNY']  # currency
...
fundq = pd.read_pickle('./fundq_chn_2000.pkl')
...
fundq = fundq[ (fundq['exchg'] == 249) | (fundq['exchg'] == 250)] # shanghai / shenzhen
...
with open('chars_q_rank.feather', 'wb') as f:
...
with open('chars_a.feather', 'wb') as f:
    feather.write_feather(fasm, f)

with open('chars_a_rank.feather', 'wb') as f:
