...
# CRSP Block / read daily, ret, exret, fama-french 3 factor different countries need diffrent factor
crsp = conn.raw_sql("""
...
def sub_df(start, end, step): #拆data frame 跑的更快
    """
